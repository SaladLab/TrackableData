...
{
    public class TrackablePocoMySqlMapper<T>
        where T : ITrackablePoco<T>
    {
        ...
        public TrackablePocoMySqlMapper(string tableName, ColumnDefinition[] headKeyColumnDefs = null)
        {
        ...
        public async Task<List<T>> LoadAllAsync(MySqlConnection connection, params object[] keyValues)
        {
            var sql = BuildSqlForLoad(keyValues);
            var list = new List<T>();
            using (var command = new MySqlCommand(sql, connection))
        ...
        public Task<int> SaveAsync(MySqlConnection connection, IPocoTracker<T> tracker, params object[] keyValues)
        {
            return SaveAsync(connection, (TrackablePocoTracker<T>)tracker, keyValues);
        }

        public async Task<int> SaveAsync(MySqlConnection connection, TrackablePocoTracker<T> tracker,
